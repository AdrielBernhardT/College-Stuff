...
typedef enum SortBy{Location,City,Price,Rooms,Bathroom,Carpark,Type,Furnish,OutOfBound}Mode;
...
int CompareData(DataBase A,DataBase B, Mode mode,Order order){
    int result;
    if(mode == Location)
    {
